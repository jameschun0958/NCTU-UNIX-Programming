...
typedef void (*sigrestorer_t) (int);
...
long sys_rt_sigpending(sigset_t *set, size_t size);
long sys_rt_sigaction(int how, const struct sigaction *nact, struct sigaction *oact, size_t size);
long sys_rt_sigprocmask(int how, const sigset_t *set, sigset_t *oldset, size_t size);
long sys_sigreturn(unsigned long __unused);
